...
- **Platform**: Windows
- **Workspace**: C:\Users\jeastaugh\source\repos\Experiments\0.next.project
...
When the user says the plan is ready, write a detailed, human-readable requirements document to `C:\Users\jeastaugh\source\repos\Experiments\0.next.project\.devloop\requirements.md`.
...
After writing requirements.md, convert the plan into a structured task list at `C:\Users\jeastaugh\source\repos\Experiments\0.next.project\.devloop\tasks.md`.
